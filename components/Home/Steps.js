...
const Steps = () => (
  <StepsSection>
    <StepsTitle>
      <h2 className="heading">Our services are free.</h2>
    ...
    <CardGrid>
      ...
      <StepCard>
        ...
        <CardIcon>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h30a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h3a2 2 0 002-2M9 5a2 2 0 012-2h3a2 2 0 012 2m-6 9l2 2 4-4" />
          </svg>
        </CardIcon>
        <hr />
